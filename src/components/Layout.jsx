...
const Layout = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/media', label: 'Media', icon: 'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z' },
    ...
    { path: '/profile', label: 'Profile', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
  ];
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-rose-light">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link to="/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-dark hidden sm:inline">Valentine's</span>
          </Link>
              ...
              <Link
                ...
                className={`
                  ...
                  ${location.pathname === item.path
                    ? 'bg-blush text-deep'
                    : 'text-text-light hover:bg-blush hover:text-dark'
                  }
                `}
              >
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-text-light hidden lg:inline">
              {user?.first_name}
            </span>
